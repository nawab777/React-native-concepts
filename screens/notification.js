...
<ScrollView> 
  ...
  <View style={{backgroundColor:'white',height:hp(100)}}>
   <View style={styles.Container}>
      <View style={styles.coverphoto}>
        {/* page header elments  */}
           <ImageBackground source={require('../assets/data4.jpg')} style={{flex:1}}>
  ...
  <Pressable hitSlop={{top:2,left:2,right:2,bottom:2}} android_ripple={{color:'black'}} style={{backgroundColor:'white',padding:2,borderRadius:6}}>
    <AntDesign name='setting' size={24} color='black'/> 
     ...
     <TouchableOpacity>
       <View style={styles.profileimage}>
           ...
           <Image source={require('../assets/data4.jpg')}  style={{resizeMode:"stretch",width:wp(19),height:hp(9),borderRadius:9}}/>
